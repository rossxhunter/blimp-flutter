        ...
        final bool disabled = dayToBuild.isAfter(lastDate) ||
            ...
            (selectableDayPredicate != null &&
                !selectableDayPredicate(
                    dayToBuild, selectedFirstDate, selectedLastDate));
        BoxDecoration decoration;
        TextStyle itemStyle = themeData.textTheme.body1;
        final bool isSelectedFirstDay = selectedFirstDate == null
            ? false
            : selectedFirstDate.year == year &&
            ...
            onTap: () {
              ...
              if (selectedLastDate != null) {
                ...
                if (selectedFirstDate == null ||
                    dayToBuild.compareTo(selectedFirstDate) <= 0) {
                  first = dayToBuild;
...
class _YearPickerState extends State<YearPicker> {
  ...
  void initState() {
    super.initState();
    int offset;
    if (widget.selectedFirstDate == null) {
      offset = 0;
    } else if (widget.selectedLastDate != null) {
    ...
    return new ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        final bool isSelected =
            (widget.selectedFirstDate == null && year == DateTime.now().year) ||
                (widget.selectedFirstDate != null &&
                    year == widget.selectedFirstDate.year) ||
...
///
/// See [showDatePicker].
typedef bool SelectableDayPredicate(
    DateTime day, DateTime firstDay, DateTime lastDay);
...
Future<List<DateTime>> showDatePicker({
  ...
  assert(
      selectableDayPredicate == null ||
          selectableDayPredicate(initialFirstDate, null, null) ||
          selectableDayPredicate(initialLastDate, null, null),
